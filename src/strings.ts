export const t = {
  ...
  home: {
    ...
    seriesSecond: (a: number, b: number) => `Zweites Spiel der Serie – es steht ${a}:${b}`,
    seriesDecider: (a: number, b: number) => `Entscheidungsspiel – die Serie steht ${a}:${b}`,
    seriesNew: 'Neue Serie',
